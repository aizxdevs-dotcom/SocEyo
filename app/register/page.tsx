...
export default function RegisterPage() {
  ...
  const handleCreated = () => {
    setShowCreated(true);
    setTimeout(() => setShowCreated(false), 2500);
  };
    ...
    <div className="relative min-h-screen flex flex-col bg-white text-gray-900">
      ...
      <AnimatePresence>
        {showCreated && (
          <motion.div
            ...
            className="fixed top-6 left-1/2 -translate-x-1/2 bg-indigo-600 text-white px-5 py-3 rounded-full shadow-lg flex items-center gap-2 z-50"
          >
            <svg
      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="w-full max-w-md bg-white shadow-md rounded-lg border border-gray-100 p-6 sm:p-8">
          ...
          {/* Registration Form */}
          <RegisterForm onSuccess={handleCreated} />
